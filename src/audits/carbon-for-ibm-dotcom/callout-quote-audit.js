...
const UIStrings = {
  title:
    'Carbon for IBM.com Callout quote uses the recommended character count.',
  failureTitle:
    'The Carbon for IBM.com Callout quote is not using the recommended character count.',
  description:
